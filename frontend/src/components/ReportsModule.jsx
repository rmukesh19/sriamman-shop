  ...
  const customerReportData = useMemo(() => {
    return customers
      .map((c) => {
        ...
        const calculatedDue = totalSales - paidAmount;
        const outstandingAmount = c.outstanding !== undefined && c.outstanding !== null ? Number(c.outstanding) : Math.max(0, calculatedDue);
