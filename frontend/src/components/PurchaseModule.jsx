            ...
            <table className="w-full text-left text-xs font-semibold">
              <thead className="bg-slate-50 text-slate-500 border-b border-slate-200">
                <tr>
                  ...
                  <th className="p-3 text-right">Subtotal / Total (₹)</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredPurchases.map((p) => <tr key={p.id} className="hover:bg-slate-50/40">
                    ...
                    <td className="p-3 text-center text-slate-400">{p.date}</td>
                    <td className="p-3 text-right">₹{Math.round(p.total / 1.05)}</td>
                    <td className="p-3 text-right">₹{Math.round(p.total - p.total / 1.05)}</td>
                    <td className="p-3 text-right font-black text-slate-900">₹{p.total}</td>
                    <td className="p-3 text-right text-emerald-600 font-bold">₹{p.paidAmount}</td>
                    <td className="p-3 text-right text-rose-600 font-bold">₹{p.balance}</td>
